...
export declare const generateResourceFiles: (kind: GenerateKind, name: string, mode: ScaffoldMode, devServer?: DevServer, outputDir?: string, typeVariant?: TypeVariant, functionalRoutes?: boolean, testingGenerate?: boolean) => Record<string, string>;
